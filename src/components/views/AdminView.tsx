                      ...
                      <div className="text-sm text-[var(--color-lw-text)] leading-relaxed">
                        <ReactMarkdown
                          ...
                          components={{
                            ...
                            ul:     ({children}) => <ul className="list-disc list-inside space-y-0.5 mt-1 mb-3">{children}</ul>,
                            ol:     ({children}) => <ol className="list-decimal list-inside space-y-0.5 mt-1 mb-3">{children}</ol>,
                            h2:     ({children}) => <h2 className="font-bold text-[var(--color-lw-text)] text-base mt-3 mb-2 first:mt-0">{children}</h2>,
                            h3:     ({children}) => <h3 className="font-semibold text-[var(--color-lw-text)] mt-2 mb-1 first:mt-0">{children}</h3>,
